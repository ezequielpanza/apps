(() => {
  ...
  function bootstrap() {
    ...
    loadStyle('wander-map-selected-point.css?v=20260716-08');
    ...
    loadWhenReady({ ready: () => Boolean(window.WanderBase?.map && window.WanderContext), loaded: () => Boolean(window.WanderMapSelectedPoint), src: 'runtime-map-selected-point.js?v=20260716-06' });
