(() => {
  ...
  function bootstrap() {
    ...
    loadStyle('wander-map-selected-point.css?v=20260716-02');
    ...
    loadWhenReady({ ready: () => Boolean(window.WanderBase?.map && window.WanderPersonalPOIs?.list), loaded: () => Boolean(window.WanderMapSelectedPoint), src: 'runtime-map-selected-point.js?v=20260716-02' });
