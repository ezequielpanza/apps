(() => {
  ...
  loadScript('motion-state-stabilizer.js?v=20260629-1', 'motion-state-stabilizer');
  ...
  loadScript('no-magnetic-compass.js?v=20260629-1', 'no-magnetic-compass');
  loadScript('context-status-label.js?v=20260629-1', 'context-status-label');
  loadScript('speed-heading-metrics.js?v=20260629-1', 'speed-heading-metrics');
})();