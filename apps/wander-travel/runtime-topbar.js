(() => {
  ...
  function installStyles() {
    ...
    style.textContent = `
      ...
      .wander-top-query-bar .modern-menu-button{display:flex!important;flex-direction:column!important;align-items:center!important;justify-content:center!important;gap:4px!important}
      .wander-top-query-bar .modern-menu-button span{display:block!important;width:24px!important;height:2.4px!important;margin:0!important;border-radius:999px!important;background:currentColor!important;opacity:.92!important;flex:0 0 auto!important}
