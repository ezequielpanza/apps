(() => {
  ...
  manualLocationButton.innerHTML = '<span aria-hidden="true">📍</span><strong>Fijar posición</strong>';
  const stopButton = movePad.querySelector('[data-stop-move]');
  if (stopButton) {
    stopButton.textContent = '🛑';
    stopButton.setAttribute('aria-label', 'Parar simulación');
  ...
  style.textContent = `
    ...
    body.wander-clean-ui #manual-location-button.overlay-location-button,.movement-overlay #manual-location-button.overlay-location-button{display:flex!important;align-items:center!important;justify-content:center!important;gap:6px!important;width:100%!important;min-width:0!important;height:auto!important;min-height:0!important;margin:0!important;padding:10px 12px!important;border:0!important;border-radius:11px!important;background:#173f3b!important;color:#fff!important;font-size:.82rem!important;line-height:1.1!important;font-weight:800!important;box-shadow:none!important;text-align:center!important;overflow:visible!important}
    body.wander-clean-ui #manual-location-button.overlay-location-button span,body.wander-clean-ui #manual-location-button.overlay-location-button strong,.movement-overlay #manual-location-button.overlay-location-button span,.movement-overlay #manual-location-button.overlay-location-button strong{display:inline!important;font-size:.82rem!important;line-height:1.1!important;color:inherit!important}
    ...
    @media(max-width:640px){.movement-overlay{width:178px;min-width:178px;max-width:178px;left:10px;bottom:10px;padding:9px}.movement-overlay .move-pad{grid-template-columns:repeat(3,48px)!important;grid-template-rows:repeat(3,48px)!important;gap:7px!important;padding:5px!important}.movement-overlay .move-button{width:48px!important;height:48px!important;min-width:48px!important;min-height:48px!important;font-size:1.2rem!important}.movement-overlay .stop-button{font-size:1.05rem!important}}
  `;
