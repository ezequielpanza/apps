...
public class WanderLocationService extends Service implements LocationListener, SensorEventListener {
    ...
    public void onCreate() {
        ...
        motionSensor = sensorManager == null ? null : sensorManager.getDefaultSensor(Sensor.TYPE_LINEAR_ACCELERATION);
        linearAccelerationSensor = motionSensor != null;
        if (motionSensor == null && sensorManager != null) motionSensor = sensorManager.getDefaultSensor(Sensor.TYPE_ACCELEROMETER);
