...
assert.match(dashboardOrderRuntime, /currentPlace: 2/, 'Current place must receive enough dashboard width');
assert.match(dashboardOrderRuntime, /function measuredSpan\(/, 'Dashboard span must adapt to actual value length');
