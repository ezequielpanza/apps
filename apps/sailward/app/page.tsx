...
function headingAfter(voyage: Voyage, conditions: Conditions, seconds: number) {
  ...
  const rudderTurn = (voyage.rudder / 35) * drive * 10 * voyage.rudderSensitivity * (voyage.speedKn < 0 ? -0.75 : 1);
