...
function parseMinimizedPanels(raw: string): MinimizedPanels {
  ...
  for (const panel of ["voyage", "conditions", "sails", "helm"] as const) if (saved[panel] === true) next[panel] = true;
  return next;
}
